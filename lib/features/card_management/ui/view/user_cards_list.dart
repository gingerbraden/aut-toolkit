    ...
    return SquareItemsList<UserCard>(
      ...
      floatingActionButton: isSelectionMode
        ...
        children: [
          ...
          if (viewModel.selectedIds.length != cards.length) FloatingActionButton(
            heroTag: "selectAll",
            onPressed: () {
          ...
          if (viewModel.selectedIds.length != cards.length) const SizedBox(width: 12),
          ...
          FloatingActionButton(
            ...
            onPressed: () async {
              ...
              try {
                await CardPrintingService().generateAndShareSelectedCardsPdf(
        ...
        onPressed: () {
          ...
          final docRef =
          FirebaseFirestore.instance.collection('user_cards').doc();
